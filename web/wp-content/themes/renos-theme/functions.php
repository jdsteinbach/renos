...
include_once( 'functions/functions-hydra.php' );


/**
 * YOUR FUNCTIONS
 * Any PHP you need to make you theme work goes below.
 * This way other Devs working on this site after you know
 * where to find any custom PHP you had to write.
 */
